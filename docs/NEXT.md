...
1. Add a static-export check that no `id` value starts with a digit or contains whitespace.
2. Add a static-export check that every HTML document has exactly one html element and one body
   element.
